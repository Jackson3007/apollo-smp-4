...
public class TownBankMenu extends Gui {
    ...
    protected void build() {
        ...
        inventory.setItem(34, Items.of(com.apollosmp.shop.ShopManager.STALL_BLOCK)
                .name("<#5ad1e8><bold>Buy an Auction Barrel</bold>")
                .lore("<gray>Stock it and everything inside is",
                        "<gray>listed on /ah as a town sale.",
    ...
    public void onClick(Player player, int slot, ItemStack clicked, ClickType click) {
        ...
        if (slot == 34) {
            ...
            double cost = plugin.shops().stallPrice();
            ...
            com.apollosmp.util.Items.give(player, plugin.shops().createBlock());
